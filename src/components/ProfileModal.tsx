    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-4xl max-h-[95vh] overflow-hidden">
                ...
                <div className="p-6 overflow-y-auto max-h-[calc(90vh-140px)]">
                    <form onSubmit={handleSubmit} className="space-y-8">
                        ...
                        <div className="text-center">
                            <h3 className="text-lg text-white font-semibold mb-4">Foto de Perfil</h3>
                            ...
                            <div className="mt-4 flex justify-center space-x-3">
                                <label className="cursor-pointer inline-flex items-center space-x-2 px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors">
                                ...
                                {profileImage && (
                                    <button
                                        ...
                                        className="inline-flex cursor-pointer items-center space-x-2 px-4 py-2 bg-red-500 text-white rounded-lg hover:bg-red-600 transition-colors disabled:opacity-50"
                                    >
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        <input
                                            ...
                                            className={`w-full pl-10 text-white placeholder:text-gray-400 pr-4 py-3 rounded-lg border transition-all duration-200 bg-transparent focus:ring-2 focus:border-transparent ${errors.firstName
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        <input
                                            ...
                                            onChange={handleInputChange}
                                            disabled={isSubmitting}
                                            className={`w-full pl-10 text-white placeholder:text-gray-400 pr-4 py-3 rounded-lg border transition-all duration-200 bg-transparent focus:ring-2 focus:border-transparent ${errors.lastName
                                                ? 'border-red-300 dark:border-red-600 focus:ring-red-500'
                                                : 'border-gray-300 dark:border-gray-600 focus:ring-blue-500'
                                                }`}
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        <input
                                            ...
                                            onChange={handleInputChange}
                                            disabled={isSubmitting}
                                            className={`w-full pl-10 text-white placeholder:text-gray-400 pr-4 py-3 rounded-lg border transition-all duration-200 bg-transparent focus:ring-2 focus:border-transparent ${errors.phone
                                                ? 'border-red-300 dark:border-red-600 focus:ring-red-500'
                                                : 'border-gray-300 dark:border-gray-600 focus:ring-blue-500'
                                                }`}
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <div className="relative">
                                        <input
                                            ...
                                            disabled={isSubmitting}
                                            className={`w-full pl-10 text-white placeholder:text-gray-400 pr-4 py-3 rounded-lg border transition-all duration-200 bg-transparent focus:ring-2 focus:border-transparent ${errors.cep
                                                ? 'border-red-300 dark:border-red-600 focus:ring-red-500'
                                                : 'border-gray-300 dark:border-gray-600 focus:ring-blue-500'
                                                }`}
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={handleInputChange}
                                        disabled={isSubmitting}
                                        className="w-full text-white placeholder:text-gray-400 px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-transparent focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={handleInputChange}
                                        disabled={isSubmitting}
                                        className={`w-full text-white placeholder:text-gray-400 px-4 py-3 rounded-lg border transition-all duration-200 bg-transparent focus:ring-2 focus:border-transparent ${errors.address
                                            ? 'border-red-300 dark:border-red-600 focus:ring-red-500'
                                            : 'border-gray-300 dark:border-gray-600 focus:ring-blue-500'
                                            }`}
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={handleInputChange}
                                        disabled={isSubmitting}
                                        className={`w-full text-white placeholder:text-gray-400 px-4 py-3 rounded-lg border transition-all duration-200 bg-transparent focus:ring-2 focus:border-transparent ${errors.addressNumber
                                            ? 'border-red-300 dark:border-red-600 focus:ring-red-500'
                                            : 'border-gray-300 dark:border-gray-600 focus:ring-blue-500'
                                            }`}
                                        placeholder="123"
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={handleInputChange}
                                        disabled={isSubmitting}
                                        className={`w-full text-white placeholder:text-gray-400 px-4 py-3 rounded-lg border transition-all duration-200 bg-transparent focus:ring-2 focus:border-transparent ${errors.city
                                            ? 'border-red-300 dark:border-red-600 focus:ring-red-500'
                                            : 'border-gray-300 dark:border-gray-600 focus:ring-blue-500'
                                            }`}
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={handleInputChange}
                                        disabled={isSubmitting}
                                        className={`w-full text-white placeholder:text-gray-400 px-4 py-3 rounded-lg border transition-all duration-200 bg-transparent focus:ring-2 focus:border-transparent ${errors.state
                                            ? 'border-red-300 dark:border-red-600 focus:ring-red-500'
                                            : 'border-gray-300 dark:border-gray-600 focus:ring-blue-500'
                                            }`}
                                        placeholder="SP"
                        ...
                        <div>
                            <div className="flex items-center justify-between mb-4">
                                <h3 className="text-lg text-white font-semibold">Alterar Senha</h3>
                                <button
                                    type="button"
                                    onClick={() => setShowPasswordSection(!showPasswordSection)}
                                    className="text-blue-500 cursor-pointer hover:text-blue-600 text-sm"
                                >
                            ...
                            {showPasswordSection && (
                                <div className="space-y-4 p-4 text-white bg-gray-50 dark:bg-gray-900/50 rounded-lg">
                                    <div>
                                        ...
                                        <div className="relative">
                                            <input
                                                ...
                                                className={`w-full pl-4 pr-12 py-3 rounded-lg border transition-all duration-200 bg-transparent focus:ring-2 focus:border-transparent ${passwordErrors.currentPassword
                                                    ? 'border-red-300 dark:border-red-600 focus:ring-red-500'
                                                    : 'border-gray-300 dark:border-gray-600 focus:ring-blue-500'
                                                    }`}
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            <input
                                                ...
                                                onChange={handlePasswordChange}
                                                disabled={isChangingPassword}
                                                className={`w-full pl-4 pr-12 py-3 rounded-lg border transition-all duration-200 bg-transparent focus:ring-2 focus:border-transparent ${passwordErrors.newPassword
                                                    ? 'border-red-300 dark:border-red-600 focus:ring-red-500'
                                                    : 'border-gray-300 dark:border-gray-600 focus:ring-blue-500'
                                                    }`}
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            <input
                                                ...
                                                onChange={handlePasswordChange}
                                                disabled={isChangingPassword}
                                                className={`w-full pl-4 pr-12 py-3 rounded-lg border transition-all duration-200 bg-transparent focus:ring-2 focus:border-transparent ${passwordErrors.confirmPassword
                                                    ? 'border-red-300 dark:border-red-600 focus:ring-red-500'
                                                    : 'border-gray-300 dark:border-gray-600 focus:ring-blue-500'
                                                    }`}
                                    ...
                                    <button
                                        ...
                                        disabled={isChangingPassword}
                                        className="w-full cursor-pointer flex items-center justify-center space-x-2 px-4 py-3 bg-yellow-500 text-white rounded-lg hover:bg-yellow-600 transition-colors disabled:opacity-50"
                                    >
                                        {isChangingPassword ? (
                                            <>
                ...
                {/* Footer */}
                <div className="flex items-center text-white justify-between p-6 border-t border-gray-200 dark:border-gray-700">
                    <button
                        type="button"
                        onClick={handleReset}
                        disabled={isSubmitting || isChangingPassword || isUploadingImage || isDeletingImage}
                        className="flex items-center cursor-pointer space-x-2 px-6 py-3 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors disabled:opacity-50"
                    >
                    ...
                    <div className="flex items-center space-x-3">
                        <button
                            ...
                            onClick={handleClose}
                            disabled={isSubmitting || isChangingPassword || isUploadingImage || isDeletingImage}
                            className="px-6 py-3 cursor-pointer border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors disabled:opacity-50"
                        >
                            Cancelar
                        </button>
                        <button
                            ...
                            disabled={isSubmitting || isChangingPassword || isUploadingImage || isDeletingImage}
                            className="flex items-center cursor-pointer space-x-2 px-6 py-3 bg-gradient-to-r from-blue-500 to-purple-500 text-white rounded-lg hover:shadow-lg transition-all duration-300 disabled:opacity-50"
                        >
                            {isSubmitting ? (
                                <>
                                    <Loader2 className="w-4 h-4 animate-spin" />
